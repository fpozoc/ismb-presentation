...
logoleft_name:	"img/bu_cnio.png"	# Location of the image to use.
...
Below, click on the [development code](https://gitlab.com/bu_cnio/trifid) and [poster presentation](https://gitlab.com/fpozoc/ismb2020_evocompgen_826) repositories.
